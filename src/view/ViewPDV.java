...
public class ViewPDV extends javax.swing.JFrame {
    ...
    private void salvaVenda() {
        ...
        for (int i = 0; i < jTableProdutos.getRowCount(); i++) {
          ...
          ModelProduto  modelProduto1 =    controllerProduto.retornarProdutoController(codigoProduto);

            modelVendasProdutos = new ModelVendasProdutos();
            modelProduto = new ModelProduto();
            
             modelVendasProdutos.setVenda(codigoProduto);
             modelVendasProdutos.setProduto(modelProduto1.getIdProduto());
            ...
            modelVendasProdutos.setVenProQuantidade(modelProduto1.getProEstoque()-Integer.parseInt(jTableProdutos.getValueAt(i, 3).toString()));

            //Baixa no estoque
            modelProduto.setIdProduto(modelProduto1.getIdProduto());
            ...
            if(Integer.parseInt(jTableProdutos.getValueAt(i, 3).toString())>(modelProduto1.getProEstoque())){
            JOptionPane.showMessageDialog(this, "Qtd. inexistente", "Qtd. inexistente", JOptionPane.ERROR_MESSAGE);
            return;
        }
