...
public class ViewProduto2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jTextFieldCodBarras, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(19, 19, 19))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(108, 108, 108))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jTextFieldEstoque, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(44, 44, 44)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButtonPesquisar, jTextFieldCodBarras, jTextFieldCodigo, jTextFieldEstoque, jTextFieldNome, jTextFieldPesquisar, jTextFieldValor});
        ...
        jTableProduto.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "CODIGO DE BARRAS", "NOME DO PRODUTO", "QUANTIDADE", "PREÇO VENDA"
            }
        ) {
        ...
        if (jTableProduto.getColumnModel().getColumnCount() > 0) {
            ...
            jTableProduto.getColumnModel().getColumn(2).setMinWidth(250);
            jTableProduto.getColumnModel().getColumn(2).setPreferredWidth(250);
            jTableProduto.getColumnModel().getColumn(3).setMinWidth(50);
            jTableProduto.getColumnModel().getColumn(3).setPreferredWidth(50);
            jTableProduto.getColumnModel().getColumn(4).setMinWidth(50);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jButtonNovo)
                        .addComponent(jButtonCancelar))
                    .addComponent(jButtonRelProdutos, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
       //Pega os dados da tabela e seta nos campos para a edição
        ...
        int linha = this.jTableProduto.getSelectedRow(); 
         try {
            int codigoProduto = (int) this.jTableProduto.getValueAt(linha, 1);
            
            //Recuperando dados do banco
               modelProduto =    controllerProduto.retornarProdutoController(codigoProduto);
                          System.out.print("modelProduto:_ "+ modelProduto.toString());
           ...
           // this.jTextFieldCodigo.setText(String.valueOf(modelProduto.getIdProduto()));
            ...
            this.jTextFieldCodBarras.setText(String.valueOf(modelProduto.getProCodBarra()));
  ...
  //Filtra os produtos na tabela
    ...
    private void salvarProduto() {
      ...
      // modelProduto.setIdProduto(Integer.parseInt(this.jTextFieldCodigo.getText()));
        ...
        modelProduto.setProCodBarra(Integer.parseInt(this.jTextFieldCodBarras.getText()));
    ...
    private void habilitarDesabilitarCampos(boolean condicao) {
        ...
        this.jTextFieldCodBarras.setEnabled(condicao);
