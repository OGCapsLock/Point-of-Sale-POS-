...
public class ViewUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        combox_permissoes = new javax.swing.JComboBox<>();
        ...
        jTableUsuario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "NOME DO USUÁRIO", "LOGIN", "PERMISSÕES"
            }
        ) {
        ...
        combox_permissoes.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecionar", "admin", "funcionario" }));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jPasswordFieldSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel4))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel3)
                                    .addComponent(combox_permissoes, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addContainerGap())))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(combox_permissoes, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        try{
            ...
            this.combox_permissoes.setSelectedItem(modelUsuario.getUsuPermissao());
    ...
    private void setaDadosModel(){
        ...
        modelUsuario.setUsuPermissao((String) this.combox_permissoes.getSelectedItem());
    }
    ...
    private void habilitarDesabilitarCampos(boolean condicao){
        ...
        this.combox_permissoes.setEnabled(condicao);
    ...
    private void limparCampos(){
        ...
        this.combox_permissoes.setSelectedItem("Selecionar");
    }
    ...
    private void preencheTabelaProduto(){
        ...
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                ...
                listaModelUsuarios.get(i).getUsuPermissao()
            });
        }
    ...
    private javax.swing.JComboBox<String> combox_permissoes;
